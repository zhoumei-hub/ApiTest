...
001_设备上有套餐且未过期，查询剩余天数结果正确（正）
    ...
    [Timeout]    20 seconds
    uom070010001    com.cmiot.uom.service.order.GetDevSnRemainingDaysService    invoke    { "devSn": "c99990000101"}    "resultCode":"000000"    mock_uom070010001
...
002_设备上套餐已过期或没有套餐（反）
    ...
    [Template]    HemuExecTestCases
    [Timeout]    20 seconds
    uom070020001    com.cmiot.uom.service.order.GetDevSnRemainingDaysService    invoke    { "devSn": "c99990000101"}     {"resultCode":"000000","resultMsg":"成功","data":{"remainingDays":"-1"}}    mock_uom070020001
