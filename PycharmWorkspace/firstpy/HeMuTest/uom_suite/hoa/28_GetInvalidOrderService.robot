...
001_用户有失效套餐（正）
    ...
    [Timeout]    20 seconds
    uom280010001    com.cmiot.uom.service.order.hoa.GetInvalidOrderService    invoke    {}    "resultCode":"000000"|"orderId":"100000504173"    mock_uom280010001    mock_uom280010002
    ...    mock_uom280010003    mock_uom280010004    mock_uom280010005
...
002_用户无失效套餐（反）
    ...
    [Template]    HemuExecTestCases
    [Timeout]    20 seconds
    uom280010001    com.cmiot.uom.service.order.hoa.GetInvalidOrderService    invoke    {}    "resultCode":"000000"    mock_uom280010001    mock_uom280010002
    ...    mock_uom280020003
